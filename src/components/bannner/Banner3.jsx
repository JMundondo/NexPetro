              ...
              <div className="banner-wrapper">
                <div className="banner-content">
                  ...
                  <p>
                    ...
                    solutions tailored to your unique needs. Partner with
                    NexPetro and unlock new opportunities for growth. Our
                    reliable supply, exceptional customer service, and
                    commitment to excellence will empower your business to reach
                    new heights.{" "}
                  </p>{" "}
              ...
              <div className="banner-wrapper">
                <div className="banner-content">
                  ...
                  <p>
                    Trusted by leading organizations, NexPetro is a registered
                    supplier with the Procurement Regulatory Authority of
                    Zimbabwe. Experience the difference that innovative ideas
                    and reliable products can make for your business.
                  </p>
                  <div className="banner-btn-group">
                    <Link legacyBehavior href="/contact">
                      <a className="primary-btn3">Free Consultancy</a>
            ...
            <SwiperSlide className="swiper-slide">
              <div className="banner-wrapper">
                <div className="banner-content">
                  ...
                  <p>
                    At NexPetro, we believe in sustainable practices that
                    protect the environment while driving business success. Our
                    products and operations adhere to the highest safety and
                    environmental standards, ensuring a greener future for all.
                    Join the NexPetro family and experience the power of
                    innovative solutions, reliable supply, and sustainable
                    practices. Together, let's take your business to new
                    heights.{" "}
                  </p>
                  <div className="banner-btn-group">
                    <Link legacyBehavior href="/contact">
